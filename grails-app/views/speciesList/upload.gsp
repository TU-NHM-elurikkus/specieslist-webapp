    ...
    <div>
        ...
        <div id="section" class="col-wide">
            ...
            <div id="initialPaste">
                ...
                <g:uploadForm name="csvUploadForm" id="csvUploadForm" action="parseData">
                    <div class="fileupload fileupload-new pull-left" data-provides="fileupload">
                        <div class="input-append">
                            ...
                            <span class="erk-button btn-file">
                                <span class="fileupload-new">Select file</span>
                                <span class="fileupload-exists">Change</span>
                                <input type="file" name="csvFile" id="csvFileUpload"/>
                            </span>
                            <a href="#" class="erk-button fileupload-exists" data-dismiss="fileupload">Remove</a>
                        </div>
                    </div>
                </g:uploadForm>
                ...
                <g:submitButton id="checkData2" class="actionButton erk-button" name="checkData" value="Check Data"
                ...
                <g:submitButton id="checkData" class="actionButton erk-button" name="checkData" value="Check Data"
                                onclick="javascript:parseColumns();"/>
            ...
            <div id="uploadDiv">
                ...
                <div id="processSampleUpload" class="well">
                    ...
                    <input id="uploadButton" class="datasetName actionButton erk-button" type="button" value="Upload"
