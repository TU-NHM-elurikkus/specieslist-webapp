        ...
        <div class="col-12">
            ...
            <g:if test="${lists && total>0}">
                ...
                <form class="listSearchForm" >
                    <div class="input-wrapper" id="searchLists">
                        <input class="input-wrapper__input" id="appendedInputButton" name="q" type="text" value="${params.q}" placeholder="Search in list name, description or owner">

                        <button class="btn btn-dark input-wrapper__addon" type="submit">
                            Search
                        </button>
                    </div>
                </form>
            ...
            <g:elseif test="${params.q}">
                <form class="listSearchForm" >
                    <p>
                        No Species Lists found for: <b>${params.q}</b>
                    </p>
